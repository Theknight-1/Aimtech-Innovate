...
//       )}
//       {mobileNav && (
//         <div className="z-9999 sticky top-10 w-full bg-white">
            ...
            <ul className=" hidden lg:flex items-center justify-center">
              ...
              <li className="hoverable group py-6 px-4 relative text-sm lg:text-xl ">
                ...
                <div className=" mega-menu mb-16 sm:mb-0 shadow-xl ">
                  <div className="relative bg-white p-6   w-full h-96">
                    <div className="w-full h-auto p-2 flex flex-col md:flex-row gap-6  text-brand-primary">
                      {caseStudiesData.map((categoryItem, index) => (
                        <div
                          key={index}
                          className="w-1/4 border-2  hover:shadow-2xl  rounded-lg h-auto blue-200 p-8 overflow-hidden text-wrap"
                        >
                          <h1 className="font-bold text-blue-500 text-xl">
                            {categoryItem.category}
                          </h1>
                          {categoryItem.data.map((item, idx) => (
                            <div key={idx} className="flex flex-row gap-2 mt-2">
              ...
              <li>
                <button
                  ...
                  className="rounded-lg px-3 py-2 font-semibold bg-brand-secondary flex items-center group z-10"
                >
                  <span className="mr-2 text-brand-primary hover:text-white font-bold text-xl">
                    Get Proposal
                  </span>
