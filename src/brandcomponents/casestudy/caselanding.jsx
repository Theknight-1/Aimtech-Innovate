      ...
      <section className="w-full  text-white">
        <article>
          <header className="h-auto w-full   text-center">
            ...
            <div
              className=" flex flex-wrap justify-center gap-2 p-2 mt-6 "
              aria-label="Tags"
            >
              <spna className="rounded-lg bg-brand-secondary text-brand-primary px-4 py-2 text-xl font-bold hover:bg-yellow-600">
                Marketing
              </spna>
              <span className="rounded-lg bg-brand-secondary text-brand-primary px-4 py-2 text-xl font-bold hover:bg-yellow-600">
                Branding
              </span>
              <span className="rounded-lg bg-brand-secondary text-brand-primary px-4 py-2 text-xl font-bold hover:bg-yellow-600">
                Digital
            ...
            <h1 className="text-2xl lg:text-5xl font-bold my-10">Our Achievements</h1>
          </header>
        </article>
      </section>
        ...
        <div className="flex aspect-square h-auto w-full flex-col items-start justify-center gap-y-4 p-2 lg:w-1/2">
          ...
          <div className="w-full">
            <ol className="flex h-full list-inside list-decimal flex-col gap-4 text-2xl lg:text-4xl  text-white">
              ...
              <li className="rounded p-2">
                Drive website traffic and boost sales of fitness equipment and
                accessories.
              </li>
              <li className="rounded p-2">
                Improve return on investment (ROI) and return on ad spend (ROAS)
                from advertising efforts
              </li>
              <li className="rounded  p-2">
                Enhance engagement metrics such as click-through rate (CTR) and
                conversion rate.
              </li>
            </ol>
          </div>
      ...
      <section className="flex w-full flex-col p-2 px-10 md:flex-row">
        ...
        <div className="flex lg:space-x-6 aspect-square h-auto w-full flex-col items-start justify-center gap-y-4 p-2 md:w-1/2">
          ...
          <p className="text-xl md:text-4xl leading-normal text-white">
            ...
            the funnel, using the most relevant interest targeting and also
            leveraging custom and lookalike audiences for maximum reach and
            engagement of our target audience.
          </p>
        </div>
      </section>
