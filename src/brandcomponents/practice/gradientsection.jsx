...
export default function GradientSection() {
  ...
  return (
    <>
      <section className="w-screen  font-satoshi 2xl:pt-20  h-auto  px-6 md:px-8 lg:px-16 xl:px-24 2xl:px-28 overflow-hidden md:overflow-visible">
          ...
          <div className=" w-full h-full   lg:col-span-6 lg:flex items-center justify-end    lg:justify-end ">
            <div className="w-auto h-full  lg:col-span-6 lg:flex items-center justify-end -my-4 sm:-my-0  lg:justify-end ">
              <div className=" w-full h-full flex items-center justify-center lg:justify-end relative  ">
                ...
                />
                <div className="absolute -z-10 hidden md:block w-auto min-h-96 max-h-[500px] aspect-square  bg-blue-300/50 blur-3xl rounded-full "></div>
              </div>
            </div>
          </div>
        </div>
