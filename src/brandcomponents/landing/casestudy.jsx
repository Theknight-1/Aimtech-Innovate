  ...
  return (
    <section class="container mx-auto flex flex-col items-center gap-y-10 p-10 min-h-[120vh] pb-0 mt-8">
          ...
          <div class="flip-card-inner w-full h-full">
            <div class="flip-card-front">
              <img
                ...
                src="https://static.vecteezy.com/system/resources/previews/029/772/275/large_2x/happy-successful-asian-businessman-celebrating-in-modern-office-celebrate-success-and-achieving-goals-male-entrepreneur-celebrate-winning-moments-free-photo.jpeg"
                alt=""
              />
            </div>
        ...
        <div class="flip-card aspect-square h-auto w-96">
          <div class="flip-card-inner w-full h-full">
            <div class="flip-card-front">
              <img
                className="w-full h-full object-cover"
                src="https://blog.4psa.com/wp-content/uploads/Reasons-worth-colaborating-with-your-teammates-1024x536.jpg"
                alt=""
              />
            </div>
            <div class="flip-card-back flex flex-col items-center justify-center">
      ...
      <div>
        <Link
          href="/casestudy"
          class="rounded-lg bg-yellow-400 p-4 shadow-lg font-bold hover:text-white"
        >
