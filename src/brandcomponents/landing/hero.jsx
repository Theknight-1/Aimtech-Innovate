                        ...
                        <div className="aspect-square overflow-hidden flex items-center justify-center w-full  h-full ">
                            <div className=' p-12'>
                                <div class="p-2  w-full">
                                    <div>
                                        <p class="bg-teal-accent-400 mb-4 inline-block rounded-full bg-green-200 px-3 py-px text-sm font-semibold tracking-wider text-green-900">Marketting is Key to Success</p>
                                    </div>
                                    <h2 class="mb-6 max-w-lg font-sans text-3xl font-bold tracking-tight text-slate-700 sm:text-5xl sm:leading-snug">
                                       <span className=''> The #1 Marketting agency </span><br />
                                        in {" "}
                                        <span class="inline-block text-green-500">US and Canada</span>
                                    </h2>
                                    <p class="text-base text-gray-700 md:text-lg">The only Marketing Company you will ever need.</p>
                                </div>
                                <div class="flex flex-col items-center justify-center space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2 lg:justify-start">
                                    ...
                                    <a href="https://calendly.com/ramkumar-nxtcoach/30min" target='blank' class="inline-flex h-12 w-full items-center justify-center rounded-full bg-green-500 px-6 font-medium tracking-wide text-white shadow-md outline-none transition duration-200 hover:bg-green-400 focus:ring sm:w-auto"> Schedule meet </a>
                                    <a href="/" class="inline-flex h-12 w-full items-center justify-center rounded-full border-2 border-green-500 px-4 font-semibold text-green-600 transition-colors duration-200 hover:border-y-green-400 hover:text-green-400 sm:w-auto animate-pulse bg-black animate-infinite">▶</a>
                                </div>
