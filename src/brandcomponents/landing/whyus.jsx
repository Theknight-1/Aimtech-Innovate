  ...
  const accordionData = [
    {
      ...
      content:
        "Yes , You heard it right , we provide Web Development Services.",
    },
    {
      title: "SEO Optimization",
      content:
        "Yes , You heard it right , we provide SEO Optimization services",
    },
    {
    ...
    {
      title: "Team Of Experienced Professional.",
      content:
