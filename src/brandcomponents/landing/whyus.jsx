            ...
            <div className='relative w-full gap-4 md:w-1/2 h-full p-10 flex flex-col items-center justify-start'>
                ...
                <div className='absolute z-0 w-full gap-4 md:w-1/2 h-full p-10 flex flex-col mt-16 items-center justify-start'>
                    ...
                    <div className='flex gap-4 w-full items-center justify-center'>
                        ...
                        <span className='text-sm md:text-6xl font-bold text-[#FFB700] text-center'>Why us?</span>
                        {/* <svg width="129" height="146" className='' viewBox="0 0 129 146" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M123.279 4.00354C130.739 42.3166 117.577 119.002 5.24102 119.237M5.24102 119.237L34.3014 84.6331M5.24102 119.237L41.4143 142.348" stroke="#FFB700" stroke-width="7" stroke-linecap="round" />
                        </svg> */}

                    </div>
                    <article className='max-w-xl text-sm md:text-xl text-white text-justify'>Aimtech Innovate offers premier digital marketing services at unbeatable rates in the US and Canada, thanks to our partnership with Nepal's Next Coach Incubator Program. Access top-quality work at a fraction of the cost.</article>
                    <button className="w-auto flex items-center justify-center gap-x-4 border bg-white p-4 px-8  shadow-lg">
