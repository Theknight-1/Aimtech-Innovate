...
export default function page() {
  ...
  const accordionData = [
    ...
    },
    {
      ...
      content:
        "The time it takes to see results from social media management depends on various factors, including the quality of your content, the engagement of your audience, and the competitiveness of your industry. With a well-planned strategy, you can start seeing results within 2-3 months.",
    },
    {
      title: "How does social media management help my business?",
      content:
        "Social media management helps your business by increasing brand awareness, driving website traffic, generating leads, and improving customer engagement. It also provides valuable insights into your target audience's preferences and behaviors.",
    },
    {
      title:
        "What information do you need to get started with social media management?",
      content:
        "To get started, we need access to your social media profiles, your brand guidelines, and any existing content or marketing materials. We'll also need to discuss your business goals, target audience, and any specific objectives you have for your social media presence.",
    },
    {
      title: "What are the benefits of outsourcing social media management?",
      content:
        "Outsourcing social media management to an agency offers several benefits. It allows businesses to focus on their core operations while leaving social media to experts who have the time, skills, and tools to manage it effectively. Agencies often have access to a team of specialists in content creation, design, analytics, and paid advertising, ensuring a comprehensive approach. Outsourcing also provides flexibility in terms of budget and scalability, as businesses can choose from various packages and adjust their needs as they grow.",
    },
  ];
  ...
  const featuredcase = {
    ...
    objective:
      "Develop a comprehensive social media marketing strategy, identify relevant target audience and platforms, create engaging content, increase brand awareness, website traffic, lead generation, and achieve a positive return on investment (ROI) for the AI startup.",
    challenge:
      "Reach more customers with ads and branding while creating an effective social media marketing strategy for the AI startup's products and services.",
    Process:
      "Aimtech Innovate's experts collaborated with the startup, conducted in-depth market research, identified the most promising platforms and target segments, created a tailored social media marketing plan, and implemented targeted advertising campaigns to reach the ideal customers.",
    Results:
      "By implementing a comprehensive social media marketing strategy, the AI startup experienced significant improvements in brand awareness, website traffic, lead generation, and achieved a positive return on investment (ROI) from social media marketing efforts.",
    learnings:
  ...
  return (
    <>
      <title>Social Media Marketing Services & Agency in Canada</title>
      <NextSeo
      ...
      <Hcta
        title="Get a Free Social Media Audit Report"
        d1="Get your free consultation today."
        d2="Learn how we can boost your online presence."
      />
      <Footer />
    </>
  );
