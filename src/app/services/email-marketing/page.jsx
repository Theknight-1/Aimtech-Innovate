...
export default function page() {
  const dataOBJ = {
    ...
    tagLine:
      "Drive Business Growth And Build Customer Loyalty With Effective Email Marketing Campaigns",
    desciption:
    ...
    third: {
      title:
        "A proven email marketing process to generate results for your business",
      points: [
        "Email newsletters",
        "Promotional emails",
        "Email campaigns",
  ...
  const accordionData = [
    ...
    },
    {
      ...
      content:
        "There are many ways! Offer valuable incentives like discounts or downloadable content in exchange for signups. Encourage subscriptions on your website, social media bios, and even physical business cards.",
    },
    {
      title: "What should I include in my email marketing campaigns?",
      content:
        "Focus on providing value to your subscribers. Include informative content, industry news, exclusive offers, and clear calls to action (CTAs) that tell them what you want them to do next.",
    },
    {
      title: "How often should I send emails?",
      content:
        "The frequency depends on your audience and content. It's better to send high-quality emails consistently than low-quality ones too frequently. Experiment and track open rates to find the sweet spot for your audience.",
    },
    {
      title: "How can I measure the success of my email marketing campaigns?",
      content:
        "Track key metrics like open rates, click-through rates, and conversion rates. These will tell you how engaging your emails are and how well they're driving results.",
    },
  ];
  const featuredcase = {
    title: "Increasing Email Open Rates by Resending Campaigns ",
    objective:
      "The objective was to improve email open rates by strategically resending campaigns to subscribers, ensuring that the content reaches the intended audience and maximizes engagement.",
    challenge:
      "The challenge was to identify the most effective approach to resending campaigns without overwhelming subscribers or compromising the overall effectiveness of the email marketing strategy.",
    Process:
    ...
    Results:
      "The targeted resending strategy resulted in a significant increase in email open rates, with a higher percentage of subscribers engaging with the content. The approach ensured that the content reached the intended audience, maximizing the effectiveness of the email marketing campaign.",
    learnings:
  ...
  return (
    <>
      <title>
        Email Marketing Services | Effective Email Marketing Management
      </title>
      <NextSeo
        ...
        additionalMetaTags={[
          {
            name: "keywords",
            content:
              "Email Marketing,Audience Segmentation,Compelling Content, Eye-catching Design, Clear Call-to-Action (CTA)",
          },
          {
            name: "author",
      ...
      <Hcta
        title="Get a Free Email Template"
