...
export default function About() {
    return (
        <>
            <div class="m-0 flex min-h-8 items-center justify-between border-b-2 bg-white px-4">
                <div class="hidden sm:block"></div>
                <span class="text-center text-2xl font-bold sm:hidden">+9716545465</span>
                <div class="flex flex-row items-center justify-center gap-x-4">
                    <span class="hidden md:block">☎️ Schedule Discovery Call</span>
                    <span class="hidden md:block">📞Whatsapp</span>
                    <span class="hidden text-center text-2xl font-bold sm:block">+9716545465</span>
                    <button class="rounded-lg border bg-yellow-300 p-2 px-4 sm:hidden">Get Proposal</button>
                </div>
            </div>
            <Header/>
            <section>
            ...
            <footer class="bg-gray-50 border-t-2">
                <div class="mx-auto grid max-w-screen-xl gap-y-8 gap-x-12 px-4 py-10 md:grid-cols-2 xl:grid-cols-4 xl:px-10">
                    <div class="max-w-sm">
                        <div class="mb-6 flex h-12 items-center space-x-2">
                            <span class="text-2xl font-bold">The<span class="text-blue-600">Brand</span>.</span>
                        </div>
                ...
                <div class="bg-gray-100">
                    <div class="mx-auto flex max-w-screen-xl flex-col gap-y-4 px-4 py-3 text-center text-gray-500 sm:flex-row sm:justify-between sm:text-left">
                        <div class="">© 2024 BRAND | All Rights Reserved</div>
                        <div class="">
